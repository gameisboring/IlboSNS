				...
				<div class="container" data-aos="fade-up">
					...
					<div class="row">
						<div class="col-12" style="text-align:center!important">
							<div id="postDiv">
								<h3>사진</h3>
								<div class="d-flex flex-wrap" style="padding-left: 40px;" id="contentPeopleBox">
								</div>
							</div>
						</div>
					</div>
...
function renderContentCard(d){
	...
	output += '<img alt="searchImg'+d.boNum+'" onclick="boardView('+d.boNum+')" src="${pageContext.request.contextPath}/resources/assets/img/boardFile/'+d.boFile+'">'
